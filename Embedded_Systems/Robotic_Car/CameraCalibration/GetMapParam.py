...
#Get the mapping coefficient of pixel and actual distance. Press space key to get parameter and press others to exit.
#Note: Obtaining parameters requires that the camera screen can fully see the entire checboard and point the "+" mark at the checkboard 

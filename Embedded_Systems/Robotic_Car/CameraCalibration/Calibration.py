...
#Start calibrating. Press a random key to close the image.
...
#The srorage path of image for calibration collection 
...
#read the tenth picture and make a test distortion
